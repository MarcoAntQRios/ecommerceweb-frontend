...
export class HomeComponent implements OnInit {
  ...
  faqs = [
    ...
    },
    {
      ...
      respuesta: 'Los productos se encuentran organizados por categorías y tipos, lo que permite a los usuarios encontrar más fácilmente los artículos que buscan.'
    },
    {
      pregunta: '¿Puedo actualizar el hardware después de comprar?',
      respuesta: 'Depende del modelo. Las PCs de escritorio son muy actualizables: RAM, almacenamiento, GPU y más. Las laptops suelen permitir ampliar la RAM y el SSD, aunque varía por fabricante y modelo.'
    }
  ];
  ...
  irAlRecomendador(): void { this.router.navigate(['/recomendador']); }
  ...
  toggleFaq(index: number): void { this.openFaqIndex = this.openFaqIndex === index ? null : index; }
}